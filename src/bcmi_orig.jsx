...
export default function BcmiOrig() {
  ...
  useEffect(() => {
    ...
    async function loadRevenueSummary() {
      try {
        const [revenueResponse, raResponse, winsResponse, opportunitiesResponse] = await Promise.all([
        ...
        const [revenuePayload, raPayload, winsPayload, opportunitiesPayload] = await Promise.all([revenueResponse.json(), raResponse.json(), winsResponse.json(), opportunitiesResponse.json()]);
